    ...
    */
    ...
    'reviews' => [
        ...
        [
            'key' => 'reviews.store',
            'name' => 'Create Review',
            'description' => 'Create new user reviews.',
        ...
        [
            'key' => 'reviews.update',
            'name' => 'Update Review',
            'description' => 'Update existing user reviews.',
    ...
    'complaints' => [
        ...
        [
            ...
            'description' => 'Update existing complaints.',
            'route' => 'admin.complaints.update',
            'icon' => 'pi pi-exclamation-circle',
            'sort' => 2,
        ],
        [
    ...
    'feature_requests' => [
        [
            'key' => 'feature_requests.index',
            'name' => 'Feature Requests',
            'description' => 'View feature requests.',
            'route' => 'admin.feature_requests.index',
            'icon' => 'pi pi-lightbulb',
            'sort' => 1,
        ],
        [
            'key' => 'feature_requests.store',
            'name' => 'Create Feature Request',
            'description' => 'Create new feature requests.',
            'route' => 'admin.feature_requests.store',
            'icon' => 'pi pi-lightbulb',
            'sort' => 2,
        ],
        [
            'key' => 'feature_requests.update',
            'name' => 'Update Feature Request',
            'description' => 'Update existing feature requests.',
            'route' => 'admin.feature_requests.update',
            'icon' => 'pi pi-lightbulb',
            'sort' => 2,
        ],
        [
            'key' => 'feature_requests.delete',
            'name' => 'Delete Feature Request',
            'description' => 'Delete feature requests.',
            'route' => 'admin.feature_requests.delete',
            'icon' => 'pi pi-lightbulb',
            'sort' => 3,
        ],
    ],
