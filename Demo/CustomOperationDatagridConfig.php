 ...
 */
class CustomOperationDatagridConfig extends DataGrid
{
    /**                             
    ...
    {
        /**
         * Custom operations configration.
         * 
         * Method key: insert function name which defination on blade file and provide this.
         * Type key: Add 'custom' for custom operation.
         * 
         * Refference Blade file: Demo\CustomOperationOnSamePageFromDatagrid.blade.php
         * 
         * 
         */
        $this->addAction([
            'type' => 'custom',  
            'icon' => 'icon-edit',   
            'method' => '<function name which execute by blade file>',
            'url' => function ($row) {
                return '';
            } 
        ]);
