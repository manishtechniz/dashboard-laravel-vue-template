...
use Imperial\DataGrid\Enums\ColumnTypeEnum;
use Imperial\DataGrid\Exceptions\MaatwebsiteExcelMissingException;
use Imperial\DataGrid\Exports\DataGridExport;


/**
 * This file includes code derived from Bagisto (MIT License)
...
abstract class DataGrid
{
    ...
    public function ensureMaatwebsiteExcelIsInstalled(): void
    {
        if (! class_exists(\Maatwebsite\Excel\Excel::class)) {
            throw new MaatwebsiteExcelMissingException(
                'Excel export requires "maatwebsite/excel". Run: composer require maatwebsite/excel'
            );
        }
    }
    ...
    {
        $this->ensureMaatwebsiteExcelIsInstalled();
