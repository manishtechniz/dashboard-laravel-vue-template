    ...
    methods: {
        ...
        savePermissions() {
            ...
            if (this.$axios) {
                this.$axios.post(updateUrl, {
                    ...
                    if (this.$emitter) {
                        this.$emitter.emit('add-flash', { type: 'error', message: errorMsg });
                    }
                });
            } else {
                if (this.$emitter) {
                    this.$emitter.emit('add-flash', { type: 'success', message: `Permissions updated for "${this.selectedRole.name}"` });
                }
            }
        },
        ...
        createRole() {
            ...
            if (this.$axios) {
                ...
                if (this.$emitter) {
                    this.$emitter.emit('add-flash', { type: 'success', message: `Role "${createdRole.name}" created successfully!` });
                }
            }
        },
        ...
        updateRoleDetails() {
            ...
            if (this.$axios) {
                ...
                this.showEditRoleDialog = false;
                if (this.$emitter) {
                    this.$emitter.emit('add-flash', { type: 'success', message: `Role updated successfully!` });
                }
            }
        },
        ...
        confirmDeleteRole(role) {
            ...
            if (this.$axios) {
                ...
                performDelete();
                if (this.$emitter) {
                    this.$emitter.emit('add-flash', { type: 'success', message: `Role "${role.name}" deleted successfully.` });
                }
            }
        }
    }
