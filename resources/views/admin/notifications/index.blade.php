        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="card p-6 shadow-sm">
                        ...
                        <div class="space-y-4 max-h-[470px] overflow-y-auto pr-1">
                            <div v-for="notif in notifications" :key="notif.id" class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-100 dark:border-gray-700 flex justify-between items-start gap-4">
                                <div class="flex-1">
                                    <div class="flex gap-2 items-center">
                                        ...
                                        <Tag :value="notif.type.charAt(0).toUpperCase() + notif.type.slice(1).replace('_', ' ')" severity="info" class="text-[10px] py-0 px-2" />
                                    </div>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">@{{ notif.body }}</p>
                                    <span class="text-[10px] text-gray-400 mt-2 block">To: @{{ notif.client_id ? notif.client.name : 'All Clients' }}</span>
                                </div>
