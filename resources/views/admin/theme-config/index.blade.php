<x-admin::layouts>
    ...
    <style>
        ...
        .tp-theme-card:nth-child(2n) {
            border-right: none;
        }

        .tp-theme-card:nth-child(n+3) {
            border-bottom: none;
        }
        ...
        .tp-preview-table-cell {
            height: 4.5px;
            border-radius: 2px;
            flex: 1;
        }

        .tp-preview-table-cell.wide {
            flex: 2;
        }

        .tp-preview-table-cell.pill {
        ...
        .badge-pop-enter-active {
            animation: badgeIn .2s cubic-bezier(.34, 1.56, .64, 1) both;
        }
        ...
        .tp-token-row:hover .tp-token-copy-hint {
            opacity: 1;
        }
