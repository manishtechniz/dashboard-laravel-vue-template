...
@pushOnce('scripts')
    ...
    >
            ...
            >
                <div
                    class="fixed inset-0 z-[10001] bg-gray-500/50 bg-opacity-50 transition-opacity"
                    v-show="isOpen"
                ></div>
            </transition>
            ...
            >
                ...
                >
                    <div class="flex min-h-screen items-end justify-center p-4 sm:items-center sm:p-0">
                        <div class="box-shadow relative z-[999] w-screen max-w-[568px] rounded-lg card max-lg:mb-4 max-lg:mt-4 max-md:w-[90%]">
                            <!-- Header Slot -->
                            <slot
                                name="header"
                                :toggle="toggle"
