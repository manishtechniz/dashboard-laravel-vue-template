...
@pushOnce('scripts')
                ...
                <template v-if="allowMultiple || images.length == 0">
                    ...
                    >
                        <div class="flex flex-col items-center">
                            <span class="icon-magic text-2xl text-(--active)"></span>

                            <p class="grid text-center text-sm font-semibold text-(--active)">
                                    ...
                                    <div class="flex items-center gap-x-2.5">
                                        <template v-if="! ai.images.length">
                                            <button class="secondary-button">
                                                ...
                                                <template v-else>
                                                    <span class="icon-magic text-(--active)"></span>
    ...
    <script type="module">
        adminVueApp.component('v-media-images', {
            ...
            data() {
                return {
                    ...
                    placeholders: [
                        ...
                        //     image: "{{ ('images/product-placeholders/front.svg') }}"
                        // }, {
                        //     label: "@lang('admin::app.components.media.images.placeholders.next')",
                        //     image: "{{ ('images/product-placeholders/next-1.svg') }}"
                        // }, {
                        //     label: "@lang('admin::app.components.media.images.placeholders.next')",
                        //     image: "{{ ('images/product-placeholders/next-2.svg') }}"
                        // }, {
                        //     label: "@lang('admin::app.components.media.images.placeholders.zoom')",
                        //     image: "{{ ('images/product-placeholders/zoom.svg') }}"
                        // }, {
                        //     label: "@lang('admin::app.components.media.images.placeholders.use-cases')",
                        //     image: "{{ ('images/product-placeholders/use-cases.svg') }}"
                        // }, {
                        //     label: "@lang('admin::app.components.media.images.placeholders.size')",
                        //     image: "{{ ('images/product-placeholders/size.svg') }}"
                        // }
                    ],
        ...
        adminVueApp.component('v-media-image-item', {
