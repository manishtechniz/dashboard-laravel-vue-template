        ...
        <div class="w-full">
            <div class="table-responsive grid w-full overflow-x-auto rounded card">
                ...
                >
                    ...
                    <template v-else>
                        <div
                            class="dg-header row grid min-h-[47px] items-center gap-2.5 border-b  px-4 py-2.5 font-semibold text-gray-600 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300"
                        ...
                        >
                            ...
                            <p v-if="available.massActions.length">
                                <Checkbox
                                    ...
                                    inputId="mass_action_select_all_records"
                                    @change="selectAll"
                                    binary
                                    :modelValue="['all'].includes(applied.massActions.meta.mode)"
                                />
                            </p>
                ...
                >
                    ...
                    <template v-else>
                        <template v-if="available.records.length">
                            <div
                                class="row dg-row grid items-center gap-2.5 border-b px-4 py-4 text-gray-600 transition-all hover:bg-gray-50 dark:border-gray-800 dark:text-gray-300 dark:hover:bg-gray-950"
                                v-for="(record, index) in available.records"
                                :class="[index % 2 == 0 ? 'dg-row-even' : 'dg-row-odd']"
                                :style="`grid-template-columns: repeat(${gridsCount}, minmax(150px, 1fr))`"
                            >
                                <!-- Mass Actions -->
                                <p v-if="available.massActions.length">
                                    <Checkbox
                                        ...
                                        :inputId="`mass_action_select_record_${record[available.meta.primary_column]}`"
