...
@pushOnce('scripts')
                    ...
                    <div class="flex max-w-[445px] items-center max-sm:w-full max-sm:max-w-full">
                        <div class="relative w-full ">
                            <input
                                ...
                                class="test block w-full rounded-lg border py-1.5 leading-6   transition-all hover:border-gray-400 focus:border-gray-400 bg-(--bg-subtle)  ltr:pl-3 ltr:pr-10 rtl:pl-10 rtl:pr-3"
                                :class="getSearchedValues('all')?.length ? 'border-(--active)' : ''"
    ...
    <script type="module">
        adminVueApp.component('v-datagrid-search', {
