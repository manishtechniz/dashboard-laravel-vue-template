...
@pushOnce('scripts')
    ...
    >
        <span class="relative inline-block w-full">
            ...
            <i class="icon-calendar pointer-events-none absolute top-1/2 -translate-y-1/2 text-2xl text-(--text-muted) ltr:right-2 rtl:left-2"></i>
        </span>
    </script>

    <script type="module">
        adminVueApp.component('v-date-picker', {
